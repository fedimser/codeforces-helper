...
* Automatically compiles your program and runs it agains test cases. Checks if your answers are correct. Terminates program if it times out. All this can be done on pressing **F5**.
* You can add your custom test cases.
* Assists with submittion solution: when you click **F6**, solution is copied to clipboard and your browser is opened on submission page. You only need to patse and click "Submit".
